...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExtCallAccess().getGroup(), "rule__ExtCall__Group__0");
			builder.put(grammarAccess.getExtCallAccess().getGroup_3(), "rule__ExtCall__Group_3__0");
			builder.put(grammarAccess.getExtCallAccess().getGroup_3_1(), "rule__ExtCall__Group_3_1__0");
			...
			builder.put(grammarAccess.getExtCallAccess().getRefAssignment_1(), "rule__ExtCall__RefAssignment_1");
			builder.put(grammarAccess.getExtCallAccess().getArgsAssignment_3_0(), "rule__ExtCall__ArgsAssignment_3_0");
			builder.put(grammarAccess.getExtCallAccess().getArgsAssignment_3_1_1(), "rule__ExtCall__ArgsAssignment_3_1_1");
