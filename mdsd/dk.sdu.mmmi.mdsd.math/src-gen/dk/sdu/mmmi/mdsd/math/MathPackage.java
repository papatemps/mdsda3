...
public interface MathPackage extends EPackage
{
   ...
   * @ordered
   */
  int EXTERNAL__TYPES = BINDING_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int PARENTHESIS_FEATURE_COUNT = 1;
  ...
  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.ExtCallImpl <em>Ext Call</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.ExtCallImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getExtCall()
   * @generated
   */
  int EXT_CALL = 9;
   ...
   * @ordered
   */
  int EXT_CALL__REF = EXPRESSION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int EXT_CALL__ARGS = EXPRESSION_FEATURE_COUNT + 1;

  /**
   * The number of structural features of the '<em>Ext Call</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int EXT_CALL_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.ExtCall <em>Ext Call</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Ext Call</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExtCall
   * @generated
   */
  EClass getExtCall();

  /**
   * Returns the meta object for the reference '{@link dk.sdu.mmmi.mdsd.math.ExtCall#getRef <em>Ref</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Ref</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExtCall#getRef()
   * @see #getExtCall()
   * @generated
   */
  EReference getExtCall_Ref();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.ExtCall#getArgs <em>Args</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Args</em>'.
   * @see dk.sdu.mmmi.mdsd.math.ExtCall#getArgs()
   * @see #getExtCall()
   * @generated
   */
  EReference getExtCall_Args();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.ExtCallImpl <em>Ext Call</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.ExtCallImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getExtCall()
     * @generated
     */
    EClass EXT_CALL = eINSTANCE.getExtCall();
     ...
     * @generated
     */
    EReference EXT_CALL__REF = eINSTANCE.getExtCall_Ref();
     ...
     * @generated
     */
    EReference EXT_CALL__ARGS = eINSTANCE.getExtCall_Args();
